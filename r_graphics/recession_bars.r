...
#http://jeffreybreen.wordpress.com/2011/08/15/recession-bars/


library(quantmod) # Fetch financial time series (and other?) data.
library(ggplot2)

getSymbols('UNRATE',src='FRED', auto.assign=F)
